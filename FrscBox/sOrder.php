...
class sOrder
{
    ...
    public function makeb2bBox($data,$kg = 25)
    {
        $weight = 0;
        $result = [];
...
//        $shipping_price = 0;
        if ($user_group === 'H') {
            ...
            if ($box['boxes'] >= 1){
                $frozen = true;
                $shipping_price = 12.95 * $box['boxes'];
                $shipping_price_net = 12.95 * $box['boxes'];
            }
        }else{
            $box = $this->makeBox($all_together);
            if ($box['remTotal'] > 820 && $box['remTotal'] < 990){
                $frozen = true;
                $shipping_price = 6.9;
                $shipping_price_net = 6.9;
            }
        }
